        ...
        <el-row>
          <el-card :class="'stage-card stage-1 ' + expandClass.stage1">
            <div v-if="abbrInfo.stage1">
              ...
              <div class="expand-btn" @click="cardExpand('stage1')">查看</div>
            </div>
            <div v-else>
              <el-col :span="8">
                <span>进攻宽度</span><br />
        ...
        <el-row>
          <el-card :class="'stage-card stage-2 ' + expandClass.stage2">
            <div v-if="abbrInfo.stage2">
              ...
              <div class="expand-btn" @click="cardExpand('stage2')">查看</div>
            </div>
            <div v-else>
              <el-col :span="12">
                <el-row>
        ...
        <el-row>
          <el-card :class="'stage-card stage-2 ' + expandClass.stage3">
            <div v-if="abbrInfo.stage3">
              ...
              <div class="expand-btn" @click="cardExpand('stage3')">查看</div>
            </div>
            <div v-else>
              <el-col :span="8">
                <el-row>
...
<script>
import ChooseLineUp from '@/views/Tactics/Formation/player/components/ChooseLineUp'
